...
class Iterate(PikaLargeBase):
    __tablename__ = f"{GlobalVarEnum.APP_NAME_LOWER}_iterate"
...
class IterateRel(PikaNormBase):
    __tablename__ = f"{GlobalVarEnum.APP_NAME_LOWER}_iterate_relation"
