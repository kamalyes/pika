...
class UserGroup(PikaLargeBase):
    __tablename__ = f"{GlobalVarEnum.APP_NAME_LOWER}_user_group"
...
class Dept(PikaLargeBase):
    __tablename__ = f"{GlobalVarEnum.APP_NAME_LOWER}_department"
...
class DeptRel(PikaNormBase):
    __tablename__ = f"{GlobalVarEnum.APP_NAME_LOWER}_department_relation"
