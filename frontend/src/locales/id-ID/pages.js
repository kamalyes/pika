export default {
  ...
  'pages.login.accountLogin.errorMessage': 'Nama pengguna dan kata sandi salah（tester/1235678)',
  'pages.login.username.placeholder': 'nama pengguna: tester atau user',
  'pages.login.username.required': 'Nama pengguna harus diisi!',
  'pages.login.password.placeholder': 'kata sandi: 1235678',
