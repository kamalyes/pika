...
export const CONFIG = {
  URL: dev ? 'http://localhost:7777' : 'http://localhost:7777',
  // URL: '',
  WS_URL: dev ? 'ws://127.0.0.1:7777/ws' : 'ws://127.0.0.1:7777/ws',
  ICONFONT: IconFontUrl,
  OSS_URL: "http://yuyanqing.cn/pika",
  AVATAR_URL: 'https://api.sunweihu.com/api/sjtx/api.php?lx=2',
  DOCUMENT_URL: 'https://kamalyes.github.io/pikaDoc',
