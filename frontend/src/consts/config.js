...
export const CONFIG = {
  URL: dev ? 'http://localhost:7777' : 'https://api.pika.fun',
  // URL: '',
  WS_URL: dev ? 'ws://127.0.0.1:7777/ws' : 'wss://api.pika.fun/ws',
  // WS_URL: '/ws',

  ICONFONT: IconFontUrl,
  OSS_URL: 'http://oss.pika.fun/pika',
  AVATAR_URL: 'https://joeschmoe.io/api/v1/',
  DOCUMENT_URL: 'https://yuyanqing.github.io/pikaDoc',
