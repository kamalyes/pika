...
Pika is a platform focused on automation construction, using 'Python' + 'FastApi' + 'React' development, currently not as a production level tool, the author is working on it.  
...
I hope you can click on star⭐, thank you very much ~ and you are welcome to submit all kinds of questions.  You can add my personal wechat: 'yyq501893067', if you have ideas, welcome to submit 
