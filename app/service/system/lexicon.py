...
from app.schema.lexicon import EditSensitiveWordModel, DelSensitiveWordModel, QuerySensitiveWordOutModel, \
    QuerySensitiveWordInModel, EditAliasWordModel, QueryAliasWordOutModel, QueryAliasWordInModel, DelAliasWordModel
from app.service import Permission

router = APIRouter()


@router.post("/sensitive_word/add", name="增加敏感词")
...
@router.delete("/sensitive_word/delete", name="删除敏感词（软删）")
...
@router.post("/sensitive_word/update", name="编辑敏感词")
...
@router.get("/sensitive_word/query", name="分页获取敏感词", response_model=LimitOffsetPage[QuerySensitiveWordOutModel])
...
@router.post("/alias_word/add", name="增加化名词")
...
@router.delete("/alias_word/delete", name="删除化名词（软删）")
...
@router.post("/alias_word/update", name="编辑化名词")
...
@router.get("/alias_word/query", name="分页获取化名词", response_model=LimitOffsetPage[QueryAliasWordOutModel])
