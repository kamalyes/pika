...
from sqlalchemy import DATETIME, Column, String, BOOLEAN, TEXT, text, SMALLINT, INT
...
class ApiGBaseModel(LargeBaseModel):
    ...
    def __init__(self,url=None, id=None, level=1, base_gateway=None, protocol=1, operator=None,
