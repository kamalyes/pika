...
@Desc    :  None
"""
from sqlalchemy import BOOLEAN, DATETIME, INT, Column, ForeignKey, UniqueConstraint
...
class ApiDefinitionModel(ApiGBaseModel):
    ...
    # 调整联合唯一索引
    __table_args__ = (UniqueConstraint("directory_id", "name"), {"comment": "接口定义表"})
    directory_id = Column(
        BinaryUUID,
