...
from sqlalchemy import SMALLINT, Column, ForeignKey, String, UniqueConstraint
...
class ApiTestCaseModel(ApiGBaseModel):
    ...
    directory_id = Column(
        BinaryUUID, ForeignKey(ApiTestCaseDirectoryModel.id, ondelete="cascade", onupdate="cascade"), comment="所属module",
    )
