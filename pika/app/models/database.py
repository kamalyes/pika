...
class DatabaseModel(LargeBaseModel):
    ...
    username = Column(String(ByteSizeEnum.LENGTH_50), nullable=False, comment="登录用户名")
    ...
    sql_type = Column(INT, server_default="0", nullable=False, comment="0: mysql 1: postgresql 2: mongo")
    env_info: ClassVar[EnvironmentModel]
