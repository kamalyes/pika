...
from sqlalchemy import DATETIME, INT, SMALLINT, TEXT, Column, ForeignKey, String
...
class ApiTestResultModel(ApiGBaseModel):
    ...
    data_id = Column(
        BinaryUUID,
        ForeignKey(ApiTestCaseDataModel.id, ondelete="cascade", onupdate="cascade"),
        nullable=True,
        default=None,
        comment="testcase_data_id",
    )
