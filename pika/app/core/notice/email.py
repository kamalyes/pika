...
class EmailManger(object):
    ...
    def register_succeed_template(
        username, emp_no, email, valid_time, send_time=Moment.get_now_time(PikaGlobalVarEnum.TIME_FORMATTING_YTDHMS),
    ):
        """
        注册成功邮件模板
        Args:
    ...
    @staticmethod
    def exc_events_template(
        username, emp_no, events_key: int, send_time=Moment.get_now_time(PikaGlobalVarEnum.TIME_FORMATTING_YTDHMS),
    ):
        """
        异常操作事件邮件模板
        Args:
    ...
    @staticmethod
    def get_reg_code_template(
        email, auth_code, valid_time, redis_time=Moment.get_now_time(PikaGlobalVarEnum.TIME_FORMATTING_YTDHMS),
    ):
        """
        获取验证码模板
        Args:
    ...
    @staticmethod
    def get_security_code_template(
        username,
        emp_no,
        auth_code,
        valid_time,
    ...
    @staticmethod
    def reset_ewd_template(
        username, new_password, valid_time, send_time=Moment.get_now_time(PikaGlobalVarEnum.TIME_FORMATTING_YTDHMS),
    ):
        """
        重置密码邮件模板
        Args:
