...
class ConnectionManager:
    ...
    def get_clients(self):
        return {key: True for key in self.active_connections}
    ...
    async def pusher(sender: WebSocket, message: MsgType) -> None:
        ...
        """
        msg_mapping: dict = {str: sender.send_text, dict: sender.send_json, bytes: sender.send_bytes}
    ...
    async def send_data(self, emp_no, msg_type, record_msg):
        msg = {"type": msg_type, "record_msg": record_msg}
