...
class EditRoleActionSchema:
    def __init__(
        self,
        role_action_id: Optional[str] = Body(None, title="id", max_length=ByteSizeEnum.LENGTH_32),
        menu_id: Optional[str] = Body(None, max_length=ByteSizeEnum.LENGTH_32, title="菜单id"),
        emp_no: Optional[str] = Body(..., title="员工编号", max_length=ByteSizeEnum.LENGTH_20),
        auth_control_id: Optional[str] = Body(..., title="权限控制id", max_length=ByteSizeEnum.LENGTH_32),
