...
from app.schema.base import BaseOnlyIdSchema, BaseOnlyProjectIdSchema, BaseQuerySchema, PikaBaseModel
...
class QueryApiTestPlanInSchema(BaseOnlyProjectIdSchema, BaseQuerySchema):
    ...
    receiver: List[int] = Body([], title="消息接收人, 系统消息则该字段为空")
    msg_type: List[int] = Body([], title="消息类型 1: 系统消息 2: 其他消息")
