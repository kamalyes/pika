...
async def delete_gateway(
    id: str, user_info=Depends(Permission(RoleEnum.MANAGER)), session=Depends(async_db_session_iterator),
):
...
async def list_gateway(
    name: str = "", address: str = "", env: str = None, user_info=Depends(Permission(RoleEnum.MANAGER)),
):
