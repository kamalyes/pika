...
async def delete_organization(
    request: BaseBatchDelIdsSchema = Depends(), user_info=Depends(Permission(RoleEnum.ADMIN)),
):
...
async def list_organization(
    form: QueryOrganizationInSchema = Depends(), db: AsyncSession = Depends(async_db_session_iterator),
) -> Any:
